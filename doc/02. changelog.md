...
4. Updated client area interface design
5. Improved traffic statistics view, including monthly summaries
6. Error screens and messages refined
7. Branding and localization updates (logo, Ukrainian translation fix)
> Product reconfiguration is required after update

- - - - - -

### v2.0.2 Released 14-01-2025

1. Fixed issues related to port handling
2. Optimized the logic for setting default ports based on the presence of the `secure` flag
3. Conducted overall optimization of the code
